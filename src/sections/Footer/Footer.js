...
import { BiEnvelopeOpen, BiHeart, BiPhoneCall } from "react-icons/bi";
    ...
    <div className="Footer">
      <Flex width={"100%"}>
        ...
        <Flex className={"bottomFooter"}>
          <h3>
            With <BiHeart /> by XtraTheme. Copyright © 2024 Xtra Theme
          </h3>
          <img
            src="https://xtratheme.com/elementor/supermarket/wp-content/uploads/sites/106/2023/05/22.png"
            alt=""
          />
        </Flex>
      </Flex>
